    ...
    if model_name == "LogisticRegression":
        ...
        params = {
            ...
            "gamma": trial.suggest_float(
                "gamma", *param_ranges.get(model_name, {}).get("gamma", (0.001, 1.0))
            ),
        }
        ...
        params = {
            ...
            "max_depth": trial.suggest_int(
                "max_depth", *param_ranges.get(model_name, {}).get("max_depth", (2, 32))
            ),
        ...
        params = {
            "hidden_layer_sizes": trial.suggest_int(
                "hidden_layer_sizes",
                *param_ranges.get(model_name, {}).get("hidden_layer_sizes", (50, 200)),
            ),
            "alpha": trial.suggest_float(
                "alpha", *param_ranges.get(model_name, {}).get("alpha", (0.0001, 0.01))
            ),
        }
