...
class TestScaffoldSplitter(unittest.TestCase):
	def setUp(self):
		...
		self.splitter = ScaffoldSplitter(activity_col="y", smiles_col="smiles", test_size=0.4)

	def test_init_params(self):
		sp = ScaffoldSplitter(activity_col="y", smiles_col="s", mol_col="mol", test_size=0.3)
